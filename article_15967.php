...
<head>
    ...
    <title>Maintenance and maintenance of shears - </title>
    ...
    <!-- twitter分享 -->
    <meta property="twitter:url" content="/article_15967.php">
    <meta name="twitter:title" content="Maintenance and maintenance of shears">
    <meta name="twitter:description" content="">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:image" content="null">

    <!-- facebook分享 -->
    <meta property="og:url" content="/article_15967.php">
    <meta property="og:type" content="article">
    <meta property="og:title" content="Maintenance and maintenance of shears">
    ...
    <script>
        ...
        function shareTwitter() {
            ...
            _shareUrl += '&text=' + encodeURIComponent('Maintenance and maintenance of shears');
        ...
        function sharePinterest() {
            ...
            _shareUrl += '&description=' + encodeURIComponent('Maintenance and maintenance of shears');
            _shareUrl += '&url=' + encodeURIComponent(location.href);
            window.open(_shareUrl, '_blank');
        }
    </script>
            ...
            <div component="article.js">
                ...
                <article id="post-265"
                    ...
                    <header class="entry-header" style="text-align: center;">
                        <h1 class="entry-title">Maintenance and maintenance of shears</h1>
                        <div class="entry-meta">
                            ...
                            <span class="comment-count">
                                <span class="comments-link">
                                    ...
                                    <a href="javascript:;"><span class="screen-reader-text">于Maintenance and maintenance
                                            of shears</span>留下评论</a>
                                </span>
                            </span>
                        </div>
                    </header>
                    <div class="entry-content">
                        <div style="margin: 0 auto;">
                            <script src="//cdn.xuansiwei.com/zhang3794/article/pc/1647254774726.js"></script>
                        </div>
                    </div>
                ...
                <nav class="navigation post-navigation" role="navigation" aria-label="文章">
                    ...
                    <div class="nav-links">
                        ...
                        <div class="nav-previous">
                            <a href="/article_14404.php" rel="prev"><span class="meta-nav"
