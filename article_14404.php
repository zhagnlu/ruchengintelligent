...
<head>
    ...
    <title>How does the bending machine work? - </title>
    ...
    <script>
        ...
        function shareTwitter() {
            ...
            _shareUrl += '&text=' + encodeURIComponent('How does the bending machine work?');
        ...
        function sharePinterest() {
            ...
            _shareUrl += '&description=' + encodeURIComponent('How does the bending machine work?');
            _shareUrl += '&url=' + encodeURIComponent(location.href);
            window.open(_shareUrl, '_blank');
        }
    </script>
            ...
            <div component="article.js">
                ...
                <article id="post-265"
                    ...
                    <header class="entry-header" style="text-align: center;">
                        <h1 class="entry-title">How does the bending machine work?</h1>
                        <div class="entry-meta">
                            ...
                            <span class="posted-on">
                                ...
                                <a href="javascript:;" rel="bookmark">
                                    <time class="entry-date published">2022年02月24日</time>
                                    <time class="updated">2022年02月24日</time>
                                </a>
                            </span>
                            <span class="comment-count">
                                <span class="comments-link">
                                    ...
                                    <a href="javascript:;"><span class="screen-reader-text">于How does the bending
                                            machine work?</span>留下评论</a>
                                </span>
                            </span>
                        </div>
                    </header>
                    <div class="entry-content">
                        <div style="margin: 0 auto;">
                            <script src="//cdn.xuansiwei.com/zhang3794/article/pc/1647254122277.js"></script>
                        </div>
                    </div>
